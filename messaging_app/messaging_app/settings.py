...
SECRET_KEY = 'django-insecure-ipvn4_ii(o^@(ssamd9%nqkc626p2u!s7l%acrdu7@rhq_$3v9'
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=40),  # Access token expires in 60 minutes
